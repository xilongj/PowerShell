...
- In Part 3, we'll demonstrate using the dot method.  Then we'll show you how to use the properties of an object to complete several tasks. 
- and finally, we'll use Get-Eventlog and select-object to gain some experience using the pipeline.
